  ...
  const handleAppleSignIn = async () => {
    ...
    try {
      ...
      console.error('Apple Sign-in Error:', error);
       toast({
        title: "Falló el inicio de sesión con Apple",
        description: "No se pudo iniciar sesión con Apple. Por favor, intenta de nuevo.",
        variant: "destructive",
      })
    } finally {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background to-secondary p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Iluminando el camino para el evangelismo moderno.</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="flex-col gap-4 text-center">
           <p className="text-xs text-muted-foreground">
            ...
            <Link href="/es/signup" className="underline font-medium text-primary">
              Regístrate
            </Link>
          </p>
        </CardFooter>
